...
jQuery(document).ready(function($) {
	...
	/* ---------------------------------------------------------------------- */
	/*	Modify jQuery.show() function by addin "beforeShow" and "afterShow"  (khamyl)
	/* ---------------------------------------------------------------------- */
	...
	/* ---------------------------------------------------------------------- */
	/*	Slider switching  (Khamyl)
	/* ---------------------------------------------------------------------- */
	(function() {
	  //$(".active-slide-bar").css({"position": "absolute", "visibility": "hidden"});
  	$(".butt-prohlidka").click(function(){
  	  var $slider = $('#products-slider');
  	  if( $slider.data('init') === true ){
  	   //console.log(":)");
      }
